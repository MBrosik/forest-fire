...
def run_simulation(configuration):
    ...
    #     read_threads.append(Thread(target=producer.start_producing_messages, args=(EXCHANGE_NAME, channel, queue, store)))
    ...
    #     write_threads.append(Thread(target=consumer.consume_messages_from_queue, args=(channel, queue, store)))
